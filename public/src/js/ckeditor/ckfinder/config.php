...
$https = function (){
    return $_REQUEST['HTTPS'] ? 'https://':'http://';
};

$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => $https().getenv("SYSTEM_HOST").'/src/img/userfiles/',
    'root'         => getenv("SYSTEM_PATH_ROOT").'src/img/userfiles/', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0755,
    'chmodFolders' => 0755,
