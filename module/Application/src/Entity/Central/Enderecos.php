 ...
 * Enderecos
 *
 * @ORM\Table(schema="central", name="enderecos", indexes={@ORM\Index(name="idx_8e44042e6a540e", columns={"id_estado"}), @ORM\Index(name="idx_8e44042e4caf86b1", columns={"id_cidade"}), @ORM\Index(name="IDX_8E44042E8EC98D2A", columns={"ni"})})
 * @ORM\Entity
 */
class Enderecos
{
    ...
    /**
     * @var \Rtd\Application\Entity\Central\Cidades
     *
     * @ORM\ManyToOne(targetEntity="Rtd\Application\Entity\Central\Cidades",fetch="EAGER")
     * @ORM\JoinColumns({
    ...
    /**
     * @var \Rtd\Application\Entity\Central\Estados
     *
     * @ORM\ManyToOne(targetEntity="Rtd\Application\Entity\Central\Estados")
     * @ORM\JoinColumns({
     ...
     * Set ni.
     *
     * @param \Rtd\Application\Entity\Central\Pessoa|null $ni
     *
     * @return Enderecos
     */
    public function setNi(\Rtd\Application\Entity\Central\Pessoa $ni = null)
    {
        $this->ni = $ni;
 ...
 * Get ni.
 *
 * @return \Rtd\Application\Entity\Central\Pessoa|null
 */
 ...
 * Set idCidade.
 *
 * @param \Rtd\Application\Entity\Central\Cidades|null $idCidade
 *
 * @return Enderecos
 */
public function setIdCidade(\Rtd\Application\Entity\Central\Cidades $idCidade = null)
    {
     ...
     * Get idCidade.
     *
     * @return \Rtd\Application\Entity\Central\Cidades|null
     */
    public function getIdCidade()
{
     ...
     * Set idEstado.
     *
     * @param \Rtd\Application\Entity\Central\Estados|null $idEstado
     *
     * @return Enderecos
     */
    public function setIdEstado(\Rtd\Application\Entity\Central\Estados $idEstado = null)
    {
