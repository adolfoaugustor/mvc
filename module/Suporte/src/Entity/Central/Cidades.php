...
class Cidades
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Rtd\Suporte\Entity\Central\Estados",fetch="EAGER",cascade={"all"})
     * @ORM\JoinColumns({
     ...
     * Set estado.
     *
     * @param \Rtd\Financeiro\Entity\Central\Estados|null $estado
     *
     * @return Cidades
     */
    public function setEstado(\Rtd\Financeiro\Entity\Central\Estados $estado = null)
    {
        $this->estado = $estado;
     ...
     * Get estado.
     *
     * @return \Rtd\Financeiro\Entity\Central\Estados|null
     */
     ...
     * Add niCartorio.
     *
     * @param \Rtd\Financeiro\Entity\Central\Cartorios $niCartorio
     *
     * @return Cidades
     */
    public function addNiCartorio(\Rtd\Financeiro\Entity\Central\Cartorios $niCartorio)
    {
     ...
     */
    public function removeNiCartorio(\Rtd\Financeiro\Entity\Central\Cartorios $niCartorio)
    {
     ...
     * Add niDistribuidor.
     *
     * @param \Rtd\Financeiro\Entity\Central\Pessoa $niDistribuidor
     *
     * @return Cidades
     */
    public function addNiDistribuidor(\Rtd\Financeiro\Entity\Central\Pessoa $niDistribuidor)
    {
     ...
     * @return boolean TRUE if this collection contained the specified element, FALSE otherwise.
     */
    public function removeNiDistribuidor(\Rtd\Financeiro\Entity\Central\Pessoa $niDistribuidor)
    {
