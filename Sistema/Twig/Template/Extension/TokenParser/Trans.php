...
namespace Sistema\Twig\Template\Extension\TokenParser;
...
use Sistema\Twig\Template\Extension\Node;

/**
 * Token parser da tag trans.
 *
 * Essa implementação foi obtida da biblioteca twigphp/Twig-extensions
 *
...
class Trans extends AbstractTokenParser
{
    ...
    public function parse(Twig_Token $token)
    {
        ...
        return new Node\Trans($body, $plural, $count, $notes, $lineno, $this->getTag());
    }
